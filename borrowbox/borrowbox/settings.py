"""
Django settings for borrowbox project.
...
SECRET_KEY = 'django-insecure-0(1&cggm28v(6c$^=-!h=!5&8m^neomvzq-ipo-nwb!upzwv#0'
...
WSGI_APPLICATION = 'borrowbox.wsgi.application'
